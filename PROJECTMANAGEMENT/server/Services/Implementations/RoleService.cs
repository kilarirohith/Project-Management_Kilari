    ...
    public class RoleService : IRoleService
    {
        ...
        public async Task<IEnumerable<RoleDTO>> GetAllAsync()
        {
            var roles = await _context.Roles
                .Include(r => r.RolePermissions) // Load permissions
                .ToListAsync();
        ...
        public async Task<RoleDTO> CreateAsync(RoleDTO roleDTO)
        {
            ...
            await _context.SaveChangesAsync(); // Save to generate Role Id
        ...
        public async Task<RoleDTO?> UpdateAsync(int id, RoleDTO roleDTO)
        {
            ...
            // 2. Clear Old Permissions & Add New Ones
        ...
        public async Task<bool> DeleteAsync(int id)
        {
            ...
            // Delete permissions first (manual cascade just in case)
