...
namespace server.Migrations
{
    ...
    [Migration("20251201120751_AddUserIdToVendor")]
    partial class AddUserIdToVendor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.Models.PasswordResetToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("server.Models.VendorWork", b =>
                {
                    ...
                    b.Property<int>("ResearchPersonUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ResearchPersonUserId");
            ...
            modelBuilder.Entity("server.Models.VendorWork", b =>
                {
                    b.HasOne("server.Models.User", "Coordinator")
                        .WithMany()
                        .HasForeignKey("CoordinatorUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("server.Models.ProjectMaster", "Project")
                        .WithMany()
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("server.Models.User", "ResearchPerson")
                        .WithMany()
                        .HasForeignKey("ResearchPersonUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
